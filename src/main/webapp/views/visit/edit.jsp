...
<head>
    <meta charset="UTF-8">
    <title>Sanatorium - edytuj wizytę</title>
...
<div class="container border border-info pt-3 mt-5">
    ...
    <div class="row p-1 align-items-center">
        ...
        <div class="col-md-4   align-items-center ">
            ...
            <h3>Nowa wizyta</h3>
            <form action="/editVisit/${visit.getId()}" method="post">
                    ...
                    <select name="doctor" class="form-control select2">
                        <option disabled selected value class="hide"> </option>
                                      <c:forEach items="${doctors}" var="doctor">
                                          <option value="<c:out value="${doctor.getId()}"/>" <c:if test="${doctor.getId() == visit.getDoctor().getId()}">selected</c:if> >
                    ...
                    <select name="patient" class="form-control select2">
                        <option disabled selected value class="hide"> </option>
                                      ...
                                      <c:forEach items="${patients}" var="patient">
                                          <option value="<c:out value="${patient.getId()}"/>"  <c:if test="${patient.getId() == visit.getPatient().getId()}">selected</c:if> >
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="date" class="form-control" dataformatas="" step="900" value="${visit.getDateTimeInHtmlFormat()}">
